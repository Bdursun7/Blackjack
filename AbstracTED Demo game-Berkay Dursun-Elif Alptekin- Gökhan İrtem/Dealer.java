...
public class Dealer {
	...
	public static void main(String[] args) {
		...
		System.out.println("-Players “Hit” to gain another card from the deck. Players “Stay” to keep their current card total. Players “Double” to multiply their bet by two ");
		System.out.println("-Dealer “Hits” until they equal or exceed 17.");
		System.out.println("-The goal is to have a higher card total than the dealer without going over 21.");
		System.out.println("-If the player total equals the dealer total, it is a “push” and the hand ends without losing or winning."); 
		...
		if (groupnumber > 0 && groupnumber <= 7) {
			...
			if (tour > 0 && tour <= 6) {
				...
				//	System.out.println(cards.keySet());
					...
					dealercard1 = cards.get(dealerCard1); //takes the value of the card and equalize to new integer variable.
					...
					for (int k = 0; k < groupnumber; k++) {
						...
						try {
							...
							// System.out.println(cards.keySet()); //we use this line to make sure that the card is removed from the deck in the making.
							System.out.println("----------------------------------");
						...
						//in this part dealer have to ask player to secure his money if dealer has ace for the first card
						if (dealercard1 == 11) {
						...
						while (playerhand < 21 || dealerhand == 21) {
							...
							//if player does not have enough money we remind it to themselves with this if clause 
							else if(answer.equalsIgnoreCase("double") && bt[k].bets * 2 > bt[k].balance) {
			...
			else System.out.println("invalid hands number: "+tour+"\nPlease start again");

		}
		else System.out.println("invalid group number: "+groupnumber+"\nPlease start again");
